...
def upgrade() -> None:
    ...
    op.add_column('meetings', sa.Column('zoom_meeting_id', sa.BigInteger(), nullable=True))
...
def downgrade() -> None:
    ...
    op.add_column('meetings', sa.Column('discord_event_id', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('meetings', sa.Column('discord_voice_channel_id', sa.TEXT(), autoincrement=False, nullable=True))
    ...
    op.add_column('groups', sa.Column('discord_voice_channel_id', sa.TEXT(), autoincrement=False, nullable=True))
