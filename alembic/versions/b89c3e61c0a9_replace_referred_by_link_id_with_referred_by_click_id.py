...
def upgrade() -> None:
    op.add_column(
        "users",
        sa.Column("referred_by_click_id", sa.Integer(), nullable=True),
    )
    op.create_foreign_key(
        "fk_users_referred_by_click_id_referral_clicks",
        "users",
        "referral_clicks",
...
def downgrade() -> None:
    op.add_column(
        "users",
        sa.Column("referred_by_link_id", sa.Integer(), nullable=True),
    )
    op.create_foreign_key(
