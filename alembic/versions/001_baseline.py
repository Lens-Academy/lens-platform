...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'completed', 'cancelled', name='cohort_status'), server_default='active', nullable=True),
    ...
    op.create_index('idx_cohorts_start_date', 'cohorts', ['cohort_start_date'], unique=False)
    ...
    sa.Column('availability_last_updated_at', postgresql.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('email_notifications_enabled', sa.Boolean(), server_default='true', nullable=True),
    sa.Column('dm_notifications_enabled', sa.Boolean(), server_default='true', nullable=True),
    ...
    sa.Column('discord_id', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_auth_codes_user_id_users'), ondelete='CASCADE'),
    ...
    sa.CheckConstraint("content_type IS NULL OR content_type IN ('module', 'lo', 'lens', 'test')", name=op.f('ck_chat_sessions_valid_chat_content_type')),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_chat_sessions_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('session_id', name=op.f('pk_chat_sessions'))
    )
    op.create_index('idx_chat_sessions_token', 'chat_sessions', ['anonymous_token'], unique=False)
    op.create_index('idx_chat_sessions_unique_anon_active', 'chat_sessions', ['anonymous_token', 'content_id'], unique=True, postgresql_where=sa.text('anonymous_token IS NOT NULL AND archived_at IS NULL'))
    op.create_index('idx_chat_sessions_unique_user_active', 'chat_sessions', ['user_id', 'content_id'], unique=True, postgresql_where=sa.text('user_id IS NOT NULL AND archived_at IS NULL'))
    op.create_index('idx_chat_sessions_user_content', 'chat_sessions', ['user_id', 'content_id', 'archived_at'], unique=False)
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_facilitators_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('facilitator_id', name=op.f('pk_facilitators'))
    )
    op.create_index('idx_facilitators_user_id', 'facilitators', ['user_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('preview', 'active', 'completed', 'merged', 'cancelled', name='group_status'), server_default='preview', nullable=True),
    sa.Column('start_date', sa.Date(), nullable=True),
    sa.Column('expected_end_date', sa.Date(), nullable=True),
    sa.Column('actual_end_date', sa.Date(), nullable=True),
    sa.Column('discord_channel_archived_at', postgresql.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('gcal_recurring_event_id', sa.Text(), nullable=True),
    sa.Column('calendar_invite_sent_at', postgresql.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['cohort_id'], ['cohorts.cohort_id'], name=op.f('fk_groups_cohort_id_cohorts'), ondelete='CASCADE'),
    ...
    sa.Column('reference_type', sa.Enum('group_id', 'meeting_id', 'cohort_id', 'user_id', name='notification_reference_type'), nullable=True),
    sa.Column('reference_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_notification_log_user_id_users'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('log_id', name=op.f('pk_notification_log'))
    )
    op.create_index('idx_notification_log_dedup', 'notification_log', ['user_id', 'message_type', 'reference_type', 'reference_id'], unique=False)
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('cohort_id', sa.Integer(), nullable=False),
    sa.Column('role', sa.Enum('participant', 'facilitator', name='cohort_role'), nullable=False),
    sa.Column('ungroupable_reason', sa.Enum('no_availability', 'no_overlap_with_others', 'no_facilitator_overlap', 'facilitator_capacity', 'insufficient_group_size', name='ungroupable_reason'), nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['cohort_id'], ['cohorts.cohort_id'], name=op.f('fk_signups_cohort_id_cohorts'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_signups_user_id_users'), ondelete='CASCADE'),
    ...
    sa.CheckConstraint("content_type IN ('module', 'lo', 'lens', 'test')", name=op.f('ck_user_content_progress_valid_content_type')),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_user_content_progress_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_user_content_progress'))
    )
    op.create_index('idx_user_content_progress_anon', 'user_content_progress', ['anonymous_token', 'content_id'], unique=True, postgresql_where=sa.text('anonymous_token IS NOT NULL'))
    op.create_index('idx_user_content_progress_token', 'user_content_progress', ['anonymous_token'], unique=False, postgresql_where=sa.text('anonymous_token IS NOT NULL'))
    op.create_index('idx_user_content_progress_user', 'user_content_progress', ['user_id', 'content_id'], unique=True, postgresql_where=sa.text('user_id IS NOT NULL'))
    op.create_table('groups_users',
    sa.Column('group_user_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=False),
    sa.Column('role', sa.Enum('participant', 'facilitator', name='group_user_role'), nullable=False),
    sa.Column('status', sa.Enum('active', 'dropped', 'completed', 'removed', name='group_user_status'), server_default='active', nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['group_id'], ['groups.group_id'], name=op.f('fk_groups_users_group_id_groups'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_groups_users_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('group_user_id', name=op.f('pk_groups_users'))
    )
    op.create_index('idx_groups_users_group_id', 'groups_users', ['group_id'], unique=False)
    op.create_index('idx_groups_users_user_id', 'groups_users', ['user_id'], unique=False)
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['cohort_id'], ['cohorts.cohort_id'], name=op.f('fk_meetings_cohort_id_cohorts'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['group_id'], ['groups.group_id'], name=op.f('fk_meetings_group_id_groups'), ondelete='CASCADE'),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('rsvp_status', sa.Enum('pending', 'attending', 'not_attending', 'tentative', name='rsvp_status'), server_default='pending', nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['meeting_id'], ['meetings.meeting_id'], name=op.f('fk_attendances_meeting_id_meetings'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_attendances_user_id_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('attendance_id', name=op.f('pk_attendances'))
    )
    op.create_index('idx_attendances_meeting_id', 'attendances', ['meeting_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_user_content_progress_user', table_name='user_content_progress', postgresql_where=sa.text('user_id IS NOT NULL'))
    op.drop_index('idx_user_content_progress_token', table_name='user_content_progress', postgresql_where=sa.text('anonymous_token IS NOT NULL'))
    op.drop_index('idx_user_content_progress_anon', table_name='user_content_progress', postgresql_where=sa.text('anonymous_token IS NOT NULL'))
    ...
    op.drop_index('idx_chat_sessions_unique_user_active', table_name='chat_sessions', postgresql_where=sa.text('user_id IS NOT NULL AND archived_at IS NULL'))
    op.drop_index('idx_chat_sessions_unique_anon_active', table_name='chat_sessions', postgresql_where=sa.text('anonymous_token IS NOT NULL AND archived_at IS NULL'))
