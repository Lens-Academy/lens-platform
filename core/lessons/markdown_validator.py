# core/lessons/markdown_validator.py
"""
Validate lesson and course Markdown files against the format specification.
...
Usage:
    python -m core.lessons.markdown_validator path/to/lessons/

Or import directly:
    from core.lessons.markdown_validator import validate_lesson, validate_lesson_file
"""
