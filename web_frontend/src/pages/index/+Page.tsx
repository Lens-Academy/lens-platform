...
import { Target, MessageSquare, Users, BookOpen, Play, Bot, UsersRound } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--landing-text-muted)" }}
              >
                Read and discuss the book together with a group. Weekly
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-8 md:gap-12 items-center">
            <div className="pl-8 sm:pl-10">
              ...
              <p
                ...
                style={{ color: "var(--landing-text-muted)" }}
              >
                We&rsquo;ll set you up with a group based on your
                availability. Each week you&rsquo;ll study the material
                with help from our AI Tutor. Then, you&rsquo;ll
                meet online with your group for a discussion guided by one
                of our navigators&thinsp;&mdash;&thinsp;experienced
                volunteers who help you get the most out of the material.
              </p>
            </div>
            <SemiDonutChart />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--landing-text-muted)" }}
              >
                Take the introduction module at your own pace to see if
                the course is right for you. When you&rsquo;re ready,
                enroll in a full course afterwards.
              </p>
              <a
                href="/course/default/module/introduction"
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--landing-text-muted)" }}
              >
                Ready to dive in? Give us your availability and preferred
                start date, and we&rsquo;ll match you with a group of
                like-minded individuals to go through the course together.
              </p>
              <a
                href="/enroll"
                className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-semibold border transition-colors duration-200"
