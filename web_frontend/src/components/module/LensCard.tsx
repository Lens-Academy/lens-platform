...
export default function LensCard({
  ...
  return (
    <Tag
      href={href}
      className={`no-underline my-2 flex items-center gap-3.5 rounded-2xl bg-white px-4 py-3.5 border border-gray-200/60 shadow-sm hover:shadow-md transition-shadow ${isCompleted ? "opacity-60" : ""}`}
    >
      <div
