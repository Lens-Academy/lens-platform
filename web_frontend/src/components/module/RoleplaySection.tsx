              ...
              {onFeedbackTrigger ? (
                <div className="text-center mb-3">
                  <button
                    onClick={() =>
                      onFeedbackTrigger(
                        "I just completed a roleplay exercise. Can you help me understand how I did and how to improve?",
                      )
                    }
                    className="text-sm px-4 py-2 border border-indigo-300 text-indigo-600 rounded-full hover:bg-indigo-100 transition-colors font-medium"
                  >
