            ...
            <div className="flex gap-1.5 shrink-0">
              ...
              {recordingState === "recording" ? (
                ...
                <button
                  ...
                  className="bg-[var(--brand-accent)] text-white p-2 rounded-lg hover:bg-[var(--brand-accent-hover)] focus:outline-none focus:ring-2 focus:ring-lens-orange-400 disabled:cursor-default min-w-[36px] min-h-[36px] transition-all active:scale-95"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
