...
export default function VideoEmbed({
  ...
  const fullBleedMargin = "calc((100vw - var(--sidebar-open-width, 0px)) / -2 + 50%)";
    ...
    return (
      <div
        ...
        style={{
          ...
          transition: "background-color 500ms ease, height 500ms cubic-bezier(0.22, 1, 0.36, 1), width 300ms ease-in-out, margin-left 300ms ease-in-out",
          scrollSnapAlign: isTheaterMode ? "center" : undefined,
          scrollMargin: isTheaterMode ? "var(--header-offset, 68px) 0 0 0" : undefined,
        }}
      >
