...
describe('chatViewReducer', () => {
  ...
  test('ACTIVATE sets hasInteracted', () => {
    const state = chatViewReducer(initialChatViewState, { type: 'ACTIVATE', messagesLength: 0 });
  ...
  test('ACTIVATE is idempotent', () => {
    const once = chatViewReducer(initialChatViewState, { type: 'ACTIVATE', messagesLength: 0 });
    const twice = chatViewReducer(once, { type: 'ACTIVATE', messagesLength: 5 });
